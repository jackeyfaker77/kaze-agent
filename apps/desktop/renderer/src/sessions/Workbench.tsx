...
import { CaretLeft, CaretRight, MagnifyingGlass, PawPrint, X } from "@phosphor-icons/react";
...
export function Workbench({ entries }: { entries: Entry[] }) {
  ...
  return <div className="workbench">
    <aside className="workbench-rail">
      <div className="workbench-brand"><PawPrint size={30} weight="fill" /><div>Hasaki<small>Dashboard</small></div></div>
